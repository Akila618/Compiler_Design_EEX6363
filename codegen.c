...
static char* new_temp() { 
    char b[32]; 
    snprintf(b,32,"t%d",++temp_counter); 
    return strdup(b); 
}
static char* new_label() { 
    char b[32]; 
    snprintf(b,32,"L%d",++label_counter); 
    return strdup(b); 
}
...
static char* get_operator(ASTNode* opNode) {
    ...
    for (ASTNode* c = opNode->child; c; c = c->sibling) {
        ...
        if (strcmp(c->name, "/") == 0) {  return strdup("/"); }
        if (strcmp(c->name, "<") == 0) { return strdup("<"); }
        if (strcmp(c->name, ">") == 0) {  return strdup(">"); }
        if (strcmp(c->name, "==") == 0) { return strdup("=="); }
        if (strcmp(c->name, "<=") == 0) { return strdup("<="); }
    ...
    if (strstr(opNode->name, "mult")) {  return strdup("*"); }
    if (strstr(opNode->name, "div")) {  return strdup("/"); }
    if (strstr(opNode->name, "add")) {  return strdup("+"); }
    if (strstr(opNode->name, "sub")) {  return strdup("-"); }
...
ASTNode* generate_ir(ASTNode* root) {
    ...
    printf("======================================================================================================\n");
    printf("[CODEGEN: OK]: Intermediate code generation completed.\n");
    printf("======================================================================================================\n");
