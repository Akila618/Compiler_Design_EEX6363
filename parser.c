...
ASTNode* aParams() {
    ...
    if (lookahead_token == ID || lookahead_token == INTEGER_LITERAL || 
        lookahead_token == FRACTION || lookahead_token == FLOAT_LITERAL || 
        lookahead_token == LEFTPAREN ||
...
ASTNode* factor() {
    ...
    if (lookahead_token == ID || lookahead_token == SELF) {
        ...
        match(FLOAT_LITERAL);
    } else if (lookahead_token == FRACTION) {
        addChild(node, createNode("fractionLit", yytext));
        match(FRACTION);
    } else if (lookahead_token == LEFTPAREN) {
        match(LEFTPAREN);
        addChild(node, arithExpr());
...
ASTNode* parse_program() {
    ...
    if (lookahead_token == 0) {
        printf("======================================================================================================\n");
        printf("[PARSER: OK]: No Syntax errors, Parsing completed successfully!\n");
        printf("======================================================================================================\n");
        ...
        printf("Syntax Error: Unexpected token at end of file\n");
    }
